...
public class ComingsoonFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.comingrecyclerView);
    ...
    private void downloadDataComing() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=b2ea1cf1dc03305e403107d496aae9d1";
